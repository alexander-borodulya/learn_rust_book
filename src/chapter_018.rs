...
fn chapter_018_3() {
    ...
    {
        use learn_rust_book::rust_book::chapter_018::Point;
    ...
    // Destructuring Enums
    {
        use learn_rust_book::rust_book::chapter_006::Message;
    ...
    {
        use learn_rust_book::rust_book::chapter_006::{MessageV2, Color};
    ...
    {
        use learn_rust_book::rust_book::chapter_018::Point4;

...
mod tests {
    ...
    fn test_parse_chapter_subchapter_0_0() {
        assert_eq!(
            ChapterID::new(0, 0),
            parse_chapter_subchapter("0.0").unwrap()
        );
        assert_eq!(
            ChapterID::new(0, 0),
            parse_chapter_subchapter("0,0").unwrap()
        ...
        assert_eq!(
            ChapterID::new(0, 0),
            parse_chapter_subchapter("ChapterID(0. 0)").unwrap()
        );
        assert_eq!(
            ChapterID::new(0, 0),
            parse_chapter_subchapter("ChapterID(0, 0)").unwrap()
    ...
    fn test_parse_chapter_subchapter_2_3() {
        assert_eq!(
            ChapterID::new(2, 3),
            parse_chapter_subchapter("2.3").unwrap()
        );
        assert_eq!(
            ChapterID::new(2, 3),
            parse_chapter_subchapter("2,3").unwrap()
        ...
        assert_eq!(
            ChapterID::new(2, 3),
            parse_chapter_subchapter("ChapterID(2,3)").unwrap()
        );
        assert_eq!(
            ChapterID::new(2, 3),
            parse_chapter_subchapter("ChapterID(2, 3)").unwrap()
